					...
					<div class="widget-toggle-expand mb-3">
						...
						<div class="widget-content-expanded">
							<ul class="simple-todo-list mt-3">
								...
								<li class="completed">Username: {{$user_details->username}}</li>
			...
			<div class="tabs">
				<ul class="nav nav-tabs tabs-primary">
					<li class="nav-item active">
						<a class="nav-link bg-transparent" href="#location" data-toggle="tab">Location</a>
					</li>
						...
						<form action="{{route('save_profile')}}" method="post" class="p-3" autocomplete="off">
							...
							<div class="form-row">
								<div class="col-md-12 text-right mt-3">
									<button type="submit" name="save_location" class="btn btn-primary modal-confirm">Add</button>
								</div>
							</div>

						</form>
						@if(count($locations)>0 && $user_details->role=="client")
							...
							<table class="table">
								...
								@foreach($locations as $location)
									<tr>
										...
										<td>{{$location->zip}}</td>
										<td><a data-confirm="This will permanently remove the location, are you sure you want to delete?" class="text-danger" href="{{url('delete_location')}}/{{$location->id}}"><i class="fa fa-trash"></i></a></td>
									</tr>
								@endforeach
								</tbody>
							</table>
